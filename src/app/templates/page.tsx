    ...
    <main className="flex flex-col min-h-[100dvh] mx-[16px]">
        ...
        <section id="hero" className="flex min-h-[40dvh] flex-1 items-center justify-center text-center">
            <div className="w-full max-w-2xl space-y-8 mx-auto">
              ...
              <BlurFade>
                <div className="w-full lg:w-max text-center"><span className="text-noir text-3xl lg:text-5xl font-bold uppercase lg:leading-[88px] dark:text-blanc">Beautifull</span><span className="text-[#e1e1e1] text-3xl lg:text-5xl font-bold uppercase lg:leading-[88px] dark:text-gris_2"> templates</span></div>
              </BlurFade>
              <BlurFade>
                <div className="grow shrink basis-0 text-center text-[#75757a] text-[17px] font-normal lg:text-[21px] font-normal leading-7">Discover 10+ Notion, Figma & Slides templates </div>
              </BlurFade>
              </div>
            </div>
        </section>
