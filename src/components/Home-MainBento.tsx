    ...
    <div className="w-full max-w-[1920px] h-auto mx-auto">
        <div className="w-full max-w-[1920px] gap-[5px] h-auto md:h-[1080px] flex flex-col">
            ...
            <div className="w-full gap-[5px] h-auto flex-col md:flex md:flex-row">
                ...
                <div className="w-full md:w-1/3 h-auto gap-[5px] flex flex-col">
                    ...
                    <div className="w-full gap-[5px] h-auto flex">
                        ...
                        <div className="w-full gap-[5px] h-auto flex flex-col">
                            ...
                            <div className="w-full h-1/2 rounded-xl bg-blanc dark:bg-noir">
                                <Image
                                    src="/home/bentoHome/6.png"
                                    alt="Picture of the author"
                                    width={640}
                                    height={295}
                                />
                ...
                <div className="w-full md:w-1/3 h-auto gap-[5px] flex flex-col">
                    ...
                    <div className="w-full h-1/3 gap-[5px] flex">
                        <div className="w-1/2 h-auto rounded-xl bg-blanc dark:bg-noir">
                            <Image
                                src="/home/bentoHome/2.png"
                                alt="Picture of the author"
                                width={315}
                                height={235}
                            />
                    ...
                    <div className="w-full h-2/3 rounded-xl bg-blanc dark:bg-noir">
                        <Image
                            src="/home/bentoHome/8.png"
                            alt="Picture of the author"
                            width={635}
                            height={575}
                        />
            ...
            <div className="w-full gap-[5px] h-auto hidden md:flex">
                ...
                <div className="w-2/6 h-auto rounded-xl bg-blanc dark:bg-noir">
                    <Image
                        src="/home/bentoHome/11.png"
                        alt="Picture of the author"
                        width={635}
                        height={260}
                    />
